...
public class salesVO {
	...
	public String toString() {
		return "salesVO [q_id=" + q_id + ", area_id=" + area_id + ", serv_id=" + serv_id + ", month_sal_money="
				...
				+ sal_money_60 + ", wkend_sal_num=" + wkend_sal_num + ", m_sal_num=" + m_sal_num + ", w_sal_num="
				+ w_sal_num + ", sal_num_10=" + sal_num_10 + ", sal_num_20=" + sal_num_20 + ", sal_num_30=" + sal_num_30
				+ ", sal_num_40=" + sal_num_40 + ", sal_num_50=" + sal_num_50 + ", sal_num_60=" + sal_num_60 + "]";
	}
